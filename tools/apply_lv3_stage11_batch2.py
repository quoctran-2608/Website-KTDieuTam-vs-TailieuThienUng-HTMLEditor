#!/usr/bin/env python3
"""Chặng 11 - Batch 2 apply nhóm an toàn cao tiếp theo."""
...
INPUT_PATH = ROOT / "docs" / "lv3-stage11-batch2-candidates.apply.json"
OUT_JSON_PATH = ROOT / "docs" / "lv3-stage11-batch2-apply.json"
OUT_MD_PATH = ROOT / "docs" / "lv3-stage11-batch2-apply.md"
...
def load_importer_module():
    ...
    spec = importlib.util.spec_from_file_location("importer_stage11b2", module_path)
...
def main() -> None:
    ...
    lines = [
        "# Chặng 11 - Batch 2 apply (conservative from auto-safe)",
        "",
