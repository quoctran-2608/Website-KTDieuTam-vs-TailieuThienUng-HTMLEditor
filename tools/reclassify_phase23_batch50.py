#!/usr/bin/env python3
"""Phase 23: batch 50 - chuyển nốt software guides + bài liên quan phần mềm sang Công cụ."""
...
OUT_JSON = ROOT / "docs" / "thu-vien-phase23-batch50.json"
OUT_MD = ROOT / "docs" / "thu-vien-phase23-batch50.md"
...
EXTRA_MOVES: Dict[str, Dict[str, str]] = {
    "thu-vien/cach-hach-toan-ban-hang-co-giam-gia-hang-ban.html": {
        "kind": "cong-cu",
        "lv1": "phan-mem-cong-cu",
        "lv2": "misa",
        "lv3": "misa-ban-hang-doanh-thu",
        "reason": "phase23-extra-misa-guide",
    },
    "thu-vien/cach-hach-toan-mang-tscd-di-gop-von-vao-cong-ty-lien-doanh.html": {
        "kind": "cong-cu",
        "lv1": "phan-mem-cong-cu",
        "lv2": "misa",
        "lv3": "misa-tscd-ccdc",
    ...
    "thu-vien/cach-hach-toan-mua-ccdc-ve-nhap-kho-sau-do-xuat-kho-su-dung.html": {
        "kind": "cong-cu",
        "lv1": "phan-mem-cong-cu",
        "lv2": "misa",
        "lv3": "misa-tscd-ccdc",
    ...
    "thu-vien/cach-hach-toan-tra-luong-bang-tien-gui-ngan-hang.html": {
        "kind": "cong-cu",
        "lv1": "phan-mem-cong-cu",
        "lv2": "misa",
        "lv3": "misa-khac",
    ...
    "thu-vien/cach-hach-toan-tra-luong-bang-tien-mat.html": {
        "kind": "cong-cu",
        "lv1": "phan-mem-cong-cu",
        "lv2": "misa",
        "lv3": "misa-khac",
    ...
    "thu-vien/cach-hach-toan-xuat-kho-hang-hoa-thanh-pham-lam-tscd.html": {
        "kind": "cong-cu",
        "lv1": "phan-mem-cong-cu",
        "lv2": "misa",
        "lv3": "misa-tscd-ccdc",
    ...
    "thu-vien/hach-toan-phai-thu-khac-thu-nhap-khac-gop-von-bang-tien-mat.html": {
        "kind": "cong-cu",
        "lv1": "phan-mem-cong-cu",
        "lv2": "misa",
        "lv3": "misa-khac",
    ...
    "thu-vien/he-thong-tai-khoan-ke-toan-theo-thong-tu-133.html": {
        "kind": "cong-cu",
        "lv1": "phan-mem-cong-cu",
        "lv2": "excel-va-cong-cu-khac",
        "lv3": "excel-cong-cu-khac",
        "reason": "phase23-extra-excel-tooling",
    },
    "thu-vien/he-thong-tai-khoan-ke-toan-theo-thong-tu-200-moi-nhat.html": {
        "kind": "cong-cu",
        "lv1": "phan-mem-cong-cu",
        "lv2": "excel-va-cong-cu-khac",
        "lv3": "excel-cong-cu-khac",
    ...
    "thu-vien/quy-dinh-ve-su-dung-phan-mem-ke-toan-theo-thong-tu-99.html": {
        "kind": "cong-cu",
        "lv1": "phan-mem-cong-cu",
        "lv2": "excel-va-cong-cu-khac",
        "lv3": "excel-cong-cu-khac",
        "reason": "phase23-extra-software-policy",
    },
}
...
def load_importer_module():
    ...
    spec = importlib.util.spec_from_file_location("importer_phase23_batch50", module_path)
...
def build_decisions(data_articles: List[Dict]) -> Dict[str, Dict[str, str]]:
    base_rows = [
        ...
        and a.get("topicLv1Key") == "phan-mem-cong-cu"
    ]
    ...
    for a in sorted(base_rows, key=lambda x: x["href"]):
        decisions[a["href"]] = {
            "kind": "cong-cu",
            "lv1": "phan-mem-cong-cu",
            "lv2": a.get("topicLv2Key") or "excel-va-cong-cu-khac",
            "lv3": a.get("topicLv3Key") or "excel-cong-cu-khac",
            "reason": "phase23-remaining-software-guides-to-cong-cu",
        }
    ...
    if len(decisions) != 50:
        raise RuntimeError(f"Phase23 cần đúng 50 bài, hiện build được {len(decisions)}")
    return decisions
...
def main() -> None:
    ...
    for href, decision in decisions.items():
        ...
        if isinstance(article.get("classificationReasons"), dict):
            article["classificationReasons"]["phase23Batch50"] = decision["reason"]
