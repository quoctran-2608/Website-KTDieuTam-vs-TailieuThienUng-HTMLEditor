#!/usr/bin/env python3
"""Phase 6 - finalize: chốt nốt 30 bài còn lại trong cohort import có table."""
...
REPORT_JSON = ROOT / "docs" / "table-fix-phase6-finalize30.json"
REPORT_MD = ROOT / "docs" / "table-fix-phase6-finalize30.md"
...
def main() -> None:
    ...
    # finalize: phần còn lại sau 5 phase batch100
    ...
    payload: Dict = {
        ...
        "phase": "table-fix-phase6-finalize30",
