#!/usr/bin/env python3
"""Phase 4: rà và sửa nhóm Hướng dẫn > Thuế > GTGT - Hóa đơn."""
...
OUT_JSON = ROOT / "docs" / "thu-vien-phase4-huong-dan-thue-gtgt-hoa-don.json"
OUT_MD = ROOT / "docs" / "thu-vien-phase4-huong-dan-thue-gtgt-hoa-don.md"
...
DECISIONS: Dict[str, Dict[str, str]] = {
    # Nhóm lạc sang Kế toán - Chứng từ/Sổ sách
    "thu-vien/cach-lap-bang-tong-hop-chi-tiet-vat-tu-hang-hoa.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chung-tu-so-sach",
        "lv3": "so-sach-tien-kho-chi-tiet",
        "reason": "mau-so-tong-hop-vat-tu-hang-hoa",
    },
    "thu-vien/cach-viet-giay-de-nghi-dieu-chinh-thu-nsnn-mau-c1-07-ns.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chung-tu-so-sach",
        "lv3": "chung-tu-cong-tac-thanh-toan",
        "reason": "chung-tu-nop-ngan-sach-c1-07a",
    },
    "thu-vien/cach-viet-giay-nop-tien-vao-ngan-sach-nha-nuoc-mau-c1-02-ns.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chung-tu-so-sach",
        "lv3": "chung-tu-cong-tac-thanh-toan",
        "reason": "chung-tu-nop-ngan-sach-c1-02",
    },
    "thu-vien/thoi-han-luu-tru-so-sach-chung-tu-ke-toan.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chung-tu-so-sach",
        "lv3": "he-thong-chung-tu-mau-bieu",
        "reason": "luu-tru-so-sach-chung-tu-ke-toan",
    },
    # Nhóm lạc sang Kế toán - Tài khoản/Hạch toán
    "thu-vien/cach-hach-toan-nguyen-vat-lieu-tai-khoan-152.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "tai-khoan-hach-toan",
        "lv3": "hang-ton-kho-gia-thanh",
        "reason": "tk152-hang-ton-kho",
    },
    "thu-vien/cach-hach-toan-cac-khoan-thu-nhap-khac-tai-khoan-711.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "tai-khoan-hach-toan",
        "lv3": "doanh-thu-chi-phi-kqkd",
        "reason": "tk711-doanh-thu-chi-phi",
    },
    # Nhóm lạc sang Thuế khác
    "thu-vien/cach-tinh-thue-gtgt-cua-ho-kinh-doanh.html": {
        "kind": "huong-dan",
        "lv1": "thue",
        "lv2": "ho-ca-nhan-kinh-doanh",
        "lv3": "hkd-tinh-thue-va-nop-thay",
        "reason": "ho-kinh-doanh-tinh-thue",
    },
    "thu-vien/cach-tinh-thue-gtgt-tncn-cho-thue-nha-moi-nhat.html": {
        "kind": "huong-dan",
        "lv1": "thue",
        "lv2": "tncn",
        "lv3": "tinh-thue-bieu-thue",
        "reason": "tncn-cho-thue-nha",
    },
    "thu-vien/bieu-thue-suat-thue-tieu-thu-dac-biet.html": {
        "kind": "huong-dan",
        "lv1": "thue",
        "lv2": "tndn",
        "lv3": "thue-suat-phuong-phap",
        "reason": "thue-tieu-thu-dac-biet",
    },
    "thu-vien/cac-doi-tuong-chiu-thue-tieu-thu-dac-biet.html": {
        "kind": "huong-dan",
        "lv1": "thue",
        "lv2": "tndn",
        "lv3": "thue-suat-phuong-phap",
    ...
    "thu-vien/cach-tinh-thue-tieu-thu-dac-biet-phai-nop.html": {
        "kind": "huong-dan",
        "lv1": "thue",
        "lv2": "tndn",
        "lv3": "thue-suat-phuong-phap",
    ...
    "thu-vien/huong-dan-ke-khai-thue-tieu-thu-dac-biet.html": {
        "kind": "huong-dan",
        "lv1": "thue",
        "lv2": "tndn",
        "lv3": "ke-khai-tam-nop-quyet-toan",
        "reason": "ke-khai-thue-ttdb",
    },
    "thu-vien/phan-mem-chiu-thue-suat-bao-nhieu-0-hay-khong-chiu-thue.html": {
        "kind": "huong-dan",
        "lv1": "thue",
        "lv2": "tndn",
        "lv3": "thue-suat-phuong-phap",
        "reason": "thue-suat-tndn-doanh-nghiep-phan-mem",
    },
    # Nhóm văn bản pháp lý
    "thu-vien/nghi-dinh-123-2020-nd-cp-quy-dinh-ve-hoa-don-chung-tu.html": {
        "kind": "van-ban",
        "lv1": "thue",
        "lv2": "nghi-dinh",
        "lv3": "nghi-dinh-gtgt-hoa-don",
        "reason": "van-ban-nghi-dinh-hoa-don",
    },
    "thu-vien/nghi-dinh-125-2020-nd-cp-quy-dinh-xu-phat-ve-hoa-don-va-thue.html": {
        "kind": "van-ban",
        "lv1": "thue",
        "lv2": "nghi-dinh",
        "lv3": "nghi-dinh-gtgt-hoa-don",
        "reason": "van-ban-nghi-dinh-xu-phat-thue",
    },
}
...
def load_importer_module():
    ...
    spec = importlib.util.spec_from_file_location("importer_phase4_huongdan_thue_gtgt", module_path)
...
def main() -> None:
    ...
    for href, decision in DECISIONS.items():
        ...
        if isinstance(article.get("classificationReasons"), dict):
            article["classificationReasons"]["phase4ThuVienThueGTGT"] = decision["reason"]
    ...
    phase_bucket_after = [
        ...
        and a.get("topicLv2Key") == "gtgt-hoa-don"
    ]

    payload = {
        "generatedAt": datetime.now().isoformat(),
        "phase": "phase4-huong-dan-thue-gtgt-hoa-don",
        ...
        "deferredManualReview": [
            {
                "href": "thu-vien/cach-lam-tron-so-khi-viet-hoa-don.html",
                "reason": "mixed-topic-hoa-don-and-so-sach",
            }
        ],
    }
    ...
    lines = [
        "# Phase 4 - Rà soát Hướng dẫn / Thuế / GTGT - Hóa đơn",
        "",
        f"- Thời gian chạy: `{datetime.now().strftime('%Y-%m-%d %H:%M:%S')}`",
        f"- Applied: **{len(applied)}**",
        f"- Skipped: **{len(skipped)}**",
        f"- Còn lại trong bucket sau phase 4: **{len(phase_bucket_after)}**",
    ...
    lines += [
        ...
        "",
        "- `thu-vien/cach-lam-tron-so-khi-viet-hoa-don.html` (bài pha trộn giữa nghiệp vụ hóa đơn và sổ sách)",
    ]
    OUT_MD.write_text("\n".join(lines) + "\n", encoding="utf-8")
