#!/usr/bin/env python3
"""Phase 13: dọn nhóm bài biểu mẫu/sổ theo dõi từ Tài sản-Kho-CCDC về Chứng từ-Sổ sách."""
...
OUT_JSON = ROOT / "docs" / "thu-vien-phase13-huong-dan-ke-toan-tai-san-kho-ccdc-forms.json"
OUT_MD = ROOT / "docs" / "thu-vien-phase13-huong-dan-ke-toan-tai-san-kho-ccdc-forms.md"
...
DECISIONS: Dict[str, Dict[str, str]] = {
    "thu-vien/cach-lap-so-tai-san-co-dinh-theo-thong-tu-200-va-133.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chung-tu-so-sach",
        "lv3": "so-sach-tien-kho-chi-tiet",
        "reason": "mau-so-tscd-s21-dn",
    },
    "thu-vien/cach-lap-so-theo-doi-tai-san-co-dinh-cong-cu-dung-cu.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chung-tu-so-sach",
        "lv3": "so-sach-tien-kho-chi-tiet",
        "reason": "mau-so-tscd-ccdc-s22-dn",
    },
    "thu-vien/cach-lap-the-tai-san-co-dinh-theo-thong-tu-200-va-133.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chung-tu-so-sach",
        "lv3": "so-sach-tien-kho-chi-tiet",
        "reason": "mau-the-tscd-s23-dn",
    },
    "thu-vien/cach-lap-so-tai-san-co-dinh-the-tai-san-co-dinh.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chung-tu-so-sach",
        "lv3": "so-sach-tien-kho-chi-tiet",
        "reason": "lap-so-tscd-tt200",
    },
    "thu-vien/cach-lap-the-tai-san-co-dinh-mau-s23-dn-theo-tt-200.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chung-tu-so-sach",
        "lv3": "so-sach-tien-kho-chi-tiet",
        "reason": "lap-the-tscd-s23-tt200",
    },
    "thu-vien/cach-lap-so-theo-doi-tscd-va-ccdc-tai-noi-su-dung.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chung-tu-so-sach",
        "lv3": "so-sach-tien-kho-chi-tiet",
        "reason": "lap-so-theo-doi-tscd-ccdc-noi-su-dung",
    },
    "thu-vien/cach-lap-bang-tong-hop-chi-tiet-vat-lieu-hang-hoa-dung-cu-san-pham.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chung-tu-so-sach",
        "lv3": "so-sach-tien-kho-chi-tiet",
        "reason": "bang-tong-hop-chi-tiet-vat-tu-hang-hoa",
    },
    "thu-vien/cach-lap-so-chi-tiet-vat-lieu-dung-cu-san-pham-hang-hoa.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chung-tu-so-sach",
        "lv3": "so-sach-tien-kho-chi-tiet",
...
def load_importer_module():
    ...
    spec = importlib.util.spec_from_file_location("importer_phase13_huongdan_ketoan_taisan_forms", module_path)
...
def main() -> None:
    ...
    for href, decision in DECISIONS.items():
        ...
        if isinstance(article.get("classificationReasons"), dict):
            article["classificationReasons"]["phase13ThuVienKeToanTaiSanKhoCCDCForms"] = decision["reason"]
    ...
    payload = {
        ...
        "phase": "phase13-huong-dan-ke-toan-tai-san-kho-ccdc-forms",
        ...
        "deferredManualReview": [
            {
                ...
                "reason": "chinh-sach-thue-vs-hach-toan-dac-thu",
            }
        ],
    }
    ...
    lines = [
        "# Phase 13 - Rà soát Hướng dẫn / Kế toán / Tài sản - Kho - CCDC (nhóm biểu mẫu/sổ)",
        "",
        f"- Thời gian chạy: `{datetime.now().strftime('%Y-%m-%d %H:%M:%S')}`",
        f"- Applied: **{len(applied)}**",
        f"- Skipped: **{len(skipped)}**",
        f"- Còn lại trong bucket sau phase 13: **{len(phase_bucket_after)}**",
