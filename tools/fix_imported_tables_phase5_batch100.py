#!/usr/bin/env python3
"""Phase 5 - chuẩn hóa table cho cohort import: batch 100 tiếp theo (offset 400)."""
...
REPORT_JSON = ROOT / "docs" / "table-fix-phase5-batch100.json"
REPORT_MD = ROOT / "docs" / "table-fix-phase5-batch100.md"
...
def main() -> None:
    ...
    payload: Dict = {
        ...
        "phase": "table-fix-phase5-batch100",
