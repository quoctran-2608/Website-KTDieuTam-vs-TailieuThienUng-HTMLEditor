#!/usr/bin/env python3
"""Phase 1 - chuẩn hóa table cho cohort import: batch 100 bài có table.

Chiến lược:
- Dựa vào danh sách 745 bài import từ docs/update-800-bai-import-log.json.
- Chỉ lấy bài có <table>.
- Đánh dấu mọi table bằng data-preserve-layout="true" (idempotent),
  để article-layout.js giữ layout nguồn + auto fit mobile.
"""
...
REPORT_JSON = ROOT / "docs" / "table-fix-phase1-batch100.json"
REPORT_MD = ROOT / "docs" / "table-fix-phase1-batch100.md"
...
def main() -> None:
    ...
    # phase 1: 100 bài đầu deterministic
    ...
    payload: Dict = {
        ...
        "phase": "table-fix-phase1-batch100",
