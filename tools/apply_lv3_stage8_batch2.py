#!/usr/bin/env python3
"""Chặng 8 - Batch 2 apply nhóm an toàn vừa (đợt 2)."""
...
INPUT_PATH = ROOT / "docs" / "lv3-stage8-batch2-candidates.apply.json"
OUT_JSON_PATH = ROOT / "docs" / "lv3-stage8-batch2-apply.json"
OUT_MD_PATH = ROOT / "docs" / "lv3-stage8-batch2-apply.md"
...
def load_importer_module():
    ...
    spec = importlib.util.spec_from_file_location("importer_stage8b2", module_path)
...
def main() -> None:
    ...
    lines = [
        "# Chặng 8 - Batch 2 apply (conservative set)",
        "",
