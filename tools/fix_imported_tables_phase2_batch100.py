#!/usr/bin/env python3
"""Phase 2 - chuẩn hóa table cho cohort import: batch 100 tiếp theo (offset 100)."""
...
REPORT_JSON = ROOT / "docs" / "table-fix-phase2-batch100.json"
REPORT_MD = ROOT / "docs" / "table-fix-phase2-batch100.md"
...
def main() -> None:
    ...
    # phase 2: 100 bài tiếp theo
    selected = candidates[100:200]
    applied = []
    skipped = []
    ...
    payload: Dict = {
        ...
        "phase": "table-fix-phase2-batch100",
