#!/usr/bin/env python3
"""Phase 2: rà và sửa nhóm Hướng dẫn > Kế toán > Chứng từ - Sổ sách."""
...
OUT_JSON = ROOT / "docs" / "thu-vien-phase2-huong-dan-ke-toan-chung-tu.json"
OUT_MD = ROOT / "docs" / "thu-vien-phase2-huong-dan-ke-toan-chung-tu.md"
...
DECISIONS: Dict[str, Dict[str, str]] = {
    # Chuyển sang nhánh nguyên tắc / chế độ
    "thu-vien/cac-hanh-vi-bi-nghiem-cam-trong-ke-toan-theo-luat-moi-nhat.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chuan-muc-che-do-nguyen-tac",
        "lv3": "nguyen-tac-ke-toan",
        "reason": "hanh-vi-nghiem-cam-ke-toan",
    },
    "thu-vien/muc-phat-vi-pham-lien-quan-den-chung-tu-so-sach-ke-toan.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chuan-muc-che-do-nguyen-tac",
        "lv3": "nguyen-tac-ke-toan",
    ...
    "thu-vien/muc-phat-vi-pham-ve-chung-tu-ke-toan.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chuan-muc-che-do-nguyen-tac",
        "lv3": "nguyen-tac-ke-toan",
        "reason": "xu-phat-chung-tu-ke-toan",
    },
    "thu-vien/muc-phat-vi-pham-quy-dinh-ve-so-ke-toan.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chuan-muc-che-do-nguyen-tac",
        "lv3": "nguyen-tac-ke-toan",
        "reason": "xu-phat-so-sach-ke-toan",
    },
    "thu-vien/nguyen-tac-chung-tu-ke-toan-lap-ky-noi-dung.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chuan-muc-che-do-nguyen-tac",
        "lv3": "nguyen-tac-ke-toan",
        "reason": "nguyen-tac-chung-tu-ke-toan",
    },
    "thu-vien/quy-dinh-ve-so-sach-ke-toan.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chuan-muc-che-do-nguyen-tac",
        "lv3": "che-do-ke-toan-va-thong-tu",
        "reason": "quy-dinh-so-sach-ke-toan",
    },
    "thu-vien/quy-dinh-ve-so-sach-ke-toan-theo-thong-tu-133.html": {
        "kind": "huong-dan",
        "lv1": "ke-toan",
        "lv2": "chuan-muc-che-do-nguyen-tac",
        "lv3": "che-do-ke-toan-va-thong-tu",
        "reason": "quy-dinh-so-sach-theo-thong-tu",
    },
    # Văn bản pháp lý về hóa đơn -> nhánh Văn bản
    "thu-vien/nghi-dinh-so-70-2025-nd-cp.html": {
        "kind": "van-ban",
        "lv1": "thue",
        "lv2": "nghi-dinh",
        "lv3": "nghi-dinh-gtgt-hoa-don",
        "reason": "nghi-dinh-phap-ly-hoa-don",
    },
}
...
def load_importer_module():
    ...
    spec = importlib.util.spec_from_file_location("importer_phase2_hdktchungtu", module_path)
...
def main() -> None:
    ...
    for href, decision in DECISIONS.items():
        ...
        if isinstance(article.get("classificationReasons"), dict):
            article["classificationReasons"]["phase2ThuVienKeToanChungTu"] = decision["reason"]
    ...
    phase_bucket_after = [
        ...
        and a.get("topicLv2Key") == "chung-tu-so-sach"
    ]

    payload = {
        "generatedAt": datetime.now().isoformat(),
        "phase": "phase2-huong-dan-ke-toan-chung-tu-so-sach",
    ...
    lines = [
        "# Phase 2 - Rà soát Hướng dẫn / Kế toán / Chứng từ - Sổ sách",
        "",
        f"- Thời gian chạy: `{datetime.now().strftime('%Y-%m-%d %H:%M:%S')}`",
        f"- Applied: **{len(applied)}**",
        f"- Skipped: **{len(skipped)}**",
        f"- Còn lại trong bucket sau phase 2: **{len(phase_bucket_after)}**",
