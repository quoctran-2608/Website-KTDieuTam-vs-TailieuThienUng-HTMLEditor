...
def article_to_record(item: Dict[str, Any], catalog_index: int, feature_image_path: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "hub_image": image,
        "image_alt": as_text(item.get("imageAlt")).strip(),
        "image_title": as_text(item.get("imageTitle")).strip(),
        "image_caption": as_text(item.get("imageCaption")).strip(),
        "image_credit": as_text(item.get("imageCredit")).strip(),
...
def write_target_article_view(tool, index_data: Dict[str, Any], article_id: str) -> bool:
    ...
    expanded = {
        ...
        "currentImage": index_data["articles"][article_id].get("image", ""),
        "currentImageAlt": index_data["articles"][article_id].get("imageAlt", ""),
        "currentImageTitle": index_data["articles"][article_id].get("imageTitle", ""),
        "currentImageCaption": index_data["articles"][article_id].get("imageCaption", ""),
        "currentImageCredit": index_data["articles"][article_id].get("imageCredit", ""),
