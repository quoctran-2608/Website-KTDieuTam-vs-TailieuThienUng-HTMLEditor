#!/usr/bin/env python3
"""Chặng 12 - Batch 1 apply từ auto-safe còn lại (siêu thận trọng)."""
...
INPUT_PATH = ROOT / "docs" / "lv3-stage12-batch1-candidates.apply.json"
OUT_JSON_PATH = ROOT / "docs" / "lv3-stage12-batch1-apply.json"
OUT_MD_PATH = ROOT / "docs" / "lv3-stage12-batch1-apply.md"
...
def load_importer_module():
    ...
    spec = importlib.util.spec_from_file_location("importer_stage12", module_path)
...
def main() -> None:
    ...
    lines = [
        "# Chặng 12 - Batch 1 apply (very conservative)",
        "",
