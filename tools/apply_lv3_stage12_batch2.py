#!/usr/bin/env python3
"""Chặng 12 - Batch 2 apply nhóm rất chắc còn lại."""
...
INPUT_PATH = ROOT / "docs" / "lv3-stage12-batch2-candidates.apply.json"
OUT_JSON_PATH = ROOT / "docs" / "lv3-stage12-batch2-apply.json"
OUT_MD_PATH = ROOT / "docs" / "lv3-stage12-batch2-apply.md"
...
def load_importer_module():
    ...
    spec = importlib.util.spec_from_file_location("importer_stage12b2", module_path)
...
def main() -> None:
    ...
    lines = [
        "# Chặng 12 - Batch 2 apply (very conservative)",
        "",
