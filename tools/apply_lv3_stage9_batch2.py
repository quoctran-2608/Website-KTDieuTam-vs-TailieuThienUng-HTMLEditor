#!/usr/bin/env python3
"""Chặng 9 - Batch 2 apply từ auto-safe (semantic guards)."""
...
INPUT_PATH = ROOT / "docs" / "lv3-stage9-batch2-candidates.apply.json"
OUT_JSON_PATH = ROOT / "docs" / "lv3-stage9-batch2-apply.json"
OUT_MD_PATH = ROOT / "docs" / "lv3-stage9-batch2-apply.md"
...
def load_importer_module():
    ...
    spec = importlib.util.spec_from_file_location("importer_stage9b2", module_path)
...
def main() -> None:
    ...
    lines = [
        "# Chặng 9 - Batch 2 apply (semantic-guard set)",
        "",
