#!/usr/bin/env python3
"""Chặng 13 - Batch 1 apply từ auto-safe còn lại (conservative)."""
...
INPUT_PATH = ROOT / "docs" / "lv3-stage13-batch1-candidates.apply.json"
OUT_JSON_PATH = ROOT / "docs" / "lv3-stage13-batch1-apply.json"
OUT_MD_PATH = ROOT / "docs" / "lv3-stage13-batch1-apply.md"
...
def load_importer_module():
    ...
    spec = importlib.util.spec_from_file_location("importer_stage13", module_path)
...
def main() -> None:
    ...
    lines = [
        "# Chặng 13 - Batch 1 apply (conservative from auto-safe)",
        "",
