#!/usr/bin/env python3
"""Phase 4 - chuẩn hóa table cho cohort import: batch 100 tiếp theo (offset 300)."""
...
REPORT_JSON = ROOT / "docs" / "table-fix-phase4-batch100.json"
REPORT_MD = ROOT / "docs" / "table-fix-phase4-batch100.md"
...
def main() -> None:
    ...
    payload: Dict = {
        ...
        "phase": "table-fix-phase4-batch100",
